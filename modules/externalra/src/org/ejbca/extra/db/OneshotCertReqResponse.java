...
public class OneshotCertReqResponse extends ExtRAResponse {
	...
	static final int CLASS_TYPE = 18; // Must be unique to all submessage classes
	 ...
	 */
	public OneshotCertReqResponse(long requestId, boolean success, String failinfo, Integer responseType, byte[] responseData) {
