...
public class P11NgCliSignPerformanceTestCommand extends P11NgCliCommandBase {
    ...
    public String getCommandDescription() {
        return "Runs a signing performance test.";
    }
    ...
    private void runSignPerformanceTest(final String alias, final String libName, final String libDir, final long slotId, final String pin,
            final int numberOfThreads, final int warmupTime, final int timeLimit, final boolean useCache, final String signatureAlgorithm)
        ...
        for (int i = 0; i < numberOfThreads; i++) {
            threads[i] = new TestSignThread(i, failureCallback, alias, libName, libDir, slotId, pin, warmupTime, timeLimit, useCache,
                    signatureAlgorithm);
        }
